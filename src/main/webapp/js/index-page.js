function addAllSaleProducts(){
	...
	.done(function(result) {
		$.each(result, function(index, key) {
			...
			var products = "<div class=\"col-md-3\"><div class=\"card\"><img class=\"card-img-top\" src=\"pictures/t-shirt01.jpeg\" alt=\"Card image cap\"><div class=\"card-body\"><h5 class=\"card-title\">"+key.product.name+"</h5><p class=\"card-text\">"+key.product.description+"</p><hr><p class=\"card-text\"> original price: "+strikedOriginalPrice+"<br>sale price: &euro;"+key.price+"</p><a href=\"product.html?"+key.product.id+"\" class=\"btn btn-primary \">Open</a></div><div class=\"card-footer\"><small class=\"text-muted\">sale started at: "+key.begin+"<br>sale ends at: "+key.end+"</small></div></div></div>";
			$(".row").append(products);
		});
	})
	.fail(function() {
